...
using AddOnService.DTO;
using AddOnService.Models;

namespace AddOnService.Controllers;
[Route("api/[controller]")]
[ApiController]

public class AddOnController : Controller
{
    private readonly AddOnServiceContext _context;

    public AddOnController(AddOnServiceContext context)
    {
        _context = context;
    }

...
namespace SriTel.Models
{
    ...
    public class PackageUsage
    {
        ...
        public required float OffPeekDataUsage { get; set; } = 0;
        public required float PeekDataUsage { get; set; } = 0;
        public required float AnytimeDateUsage { get; set; } = 0;
        public required int S2SCallMinsUsage { get; set; } = 0;
        public required int S2SSmsCountUsage { get; set; } = 0;
        public required int AnyNetCallMinsUsage { get; set; } = 0;
        public required int AnyNetSmsCountUsage { get; set; } = 0;
        public required int State { get; set; } = 1; // 0-deactivate, 1-activate

...
public class PackageController : Controller
{
    ...
    public PackageController(PackageServiceContext context)
    {
        _context = context;
    }
    ...
    public async Task<ActionResult<PackageDTO>> UpdatePackage(long id, PackageDTO packageDto)
    {
        ...
        if(packageDto.Name != string.Empty) package.Name = packageDto.Name ?? string.Empty;
        if(packageDto.Renewal != null) package.Renewal = packageDto.Renewal;
        if(packageDto.Description != string.Empty) package.Description = packageDto.Description ?? string.Empty;
        if(packageDto.Image != string.Empty) package.Image = packageDto.Image ?? string.Empty;
